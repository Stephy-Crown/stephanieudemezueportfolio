    ...
    frontend: [
      {
        name: "JavaScript",
        icon: (
          <svg viewBox="0 0 128 128" className="w-28 h-32">
      ...
      // ... rest of your skills data remains the same
    ],
  };
          ...
          <div>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              {skills.frontend.map((skill) => (
                <div
                  key={skill.name}
                  className="rounded-xl p-3 hover:shadow-lg transition-all group text-center border border-purple-100 hover:-translate-y-2 hover:border-white transform"
                >
                  <div className="h-16 relative mb-4">{skill.icon}</div>
                  <h4 className="font-semibold text-white mt-14">
                    {skill.name}
                  </h4>
                </div>
              ))}
