  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen bg-gray-900">
      ...
      <div className="relative w-32 h-32 flex justify-center items-center rounded-full">
        ...
        <div className="absolute w-16 h-16 bg-gradient-to-r from-purple-500 to-purple-500 rounded-full opacity-80" />
      ...
      {/* Portfolio text */}
      <p className="text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-purple-500 font-greatVibes text-4xl mt-6">
        Stephfolio
      </p>
    </div>
  );
